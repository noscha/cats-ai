...
- scene_description should describe only visible facts in 2-3 concise sentences, do not exceed five sentences.
...
- reasoning should explain the accident label using visible evidence in 2-3 concise sentences, do not exceed five sentences.
